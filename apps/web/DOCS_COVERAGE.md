...
Last factual audit: **2026-07-21**, against desktop tag **v1.0.0**.
...
| Collection Runner | `docs/guides/collection-runner` | `docs/reference/performance-fixtures` | Good | Completed run with per-request pass status and summary is captured. |
